...
public class Autorizar {
    ...
    @Size(min = 3, max = 100, message = "El maximo de caracteres para el nombre es de 100")
    ...
    public @NotBlank(message = "El nombre no puede ser vacio") @Size(min = 3, max = 100, message = "El maximo de caracteres para el nombre es de 100") String getNombre() {
        return nombre;
    }
    public void setNombre(@NotBlank(message = "El nombre no puede ser vacio") @Size(min = 3, max = 100, message = "El maximo de caracteres para el nombre es de 100") String nombre) {
        this.nombre = nombre;
    }
